...
$user = array(
    'USER_LOGIN' => 'granula2000@ukr.net', #Ваш логин (электронная почта)
    'USER_HASH' => 'e1611373d8acc0b7beeb452bb4d6768b7704d140', #Хэш для доступа к API (смотрите в профиле пользователя)
...
$link = "https://granula2000.amocrm.ru/private/api/auth.php?type=json";
