...
foreach ($Response as $v) {
    if (is_array($v)) {
        ...
        $sql = "INSERT INTO buyers (id, is_deleted, period_id, created_at, responsible_user_id, next_date, status_id, ltv, purchases_count, average_check, main_contact_id, contacts_ids)
