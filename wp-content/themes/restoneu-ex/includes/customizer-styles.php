...
function twx_custom_styles( $customizer_style ) {
	...
	//Background color
	$primary_color = get_theme_mod( 'primary_color', '#153043' );
	...
	if ( $banner_type == 'image' && is_front_page() ) {
		$banner_bg = 'background: url('.get_theme_mod( 'banner_bg_img', get_stylesheet_directory_uri() . '/images/homebanner1.jpg' ) . ');';
